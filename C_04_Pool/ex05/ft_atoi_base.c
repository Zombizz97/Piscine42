...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/17 19:24:38 by tribes            #+#    #+#             */
/*   Updated: 2022/08/20 20:54:04 by tribes           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_convert_base(char *str, char *base, int len_base, int i)
{
	int	power;
	int	atoi;
	int	j;
...
int	ft_atoi_base(char *str, char *base)
{
	...
	return (ft_convert_base(str, base, len_base, i) * neg);
}
